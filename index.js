...
const broadcast = function (node) {
    ...
    chatText.forEach(function (el) {
        ...
        if (spans[0] != undefined) {
            ...
            if (!processedMsgSet.has(msg) && msg.includes("quero comprar")) {
            ...
            if (!processedMsgSet.has(msg) && msg.includes("gerar um boleto")) {
